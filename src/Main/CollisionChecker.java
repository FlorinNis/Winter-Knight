    ...
    public int checkEntity(Entity entity, Entity[][] target){
        ...
        for(int i = 0; i < target[1].length; i++) {
            ...
            if(target[gp.currentMap][i] != null) {
                ...
                //get NPC CheckLoc
                target[gp.currentMap][i].checkNPC.x = target[gp.currentMap][i].worldX + target[gp.currentMap][i].checkNPC.x;
                target[gp.currentMap][i].checkNPC.y = target[gp.currentMap][i].worldY + target[gp.currentMap][i].checkNPC.y;
